...
//                 <Text> Hi ! </Text>
//                 <Button title="Close" onPress={() => this.setState({ visibleModalId: null })}/>
//             </View>
//         </View>
//     }
...
//         return(
//             <View style={styles.container}>
//                 <Button onPress={() => this.setState({visibleModal: 'default'})}
//                     title="Default"
//                 />
//                 <Modal isVisible={this.state.visibleModal === 'default'}>
//                 {this.renderModalContent()}
...
//         return(
//                 <View style={{ flex: 1}}>
//                     <Button title="Question" onPress={this.toggleModal}/>
//                     <Modal isVisible={this.state.isModalVisible} >
//                         <View style={{ flex:1 }}>
//                             <Text> I have 21 questions and its all about us !</Text>
